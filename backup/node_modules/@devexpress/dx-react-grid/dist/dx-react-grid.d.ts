...
export const withKeyboardNavigation: <T extends KeyboardNavigationComponent>(key1?: string | undefined, key2?: string | undefined) => (Component: React.ComponentType<Table.CellProps>) => React.ComponentType<T>;
