...
var Table$2 = _interopDefault(require('@mui/material/Table'));
...
var ToolbarMUI = _interopDefault(require('@mui/material/Toolbar'));
...
var StyledContainerBase = styles.styled(ContainerBase)(_defineProperty({}, "&.".concat(classes.container), {
...
var getBorder = function getBorder(theme) {
  return "1px solid ".concat(theme.palette.mode === 'light' ? styles.lighten(styles.alpha(theme.palette.divider, 1), 0.88) : styles.darken(styles.alpha(theme.palette.divider, 1), 0.68));
};
var getBrightBorder = function getBrightBorder(theme) {
  return "1px solid ".concat(theme.palette.mode === 'light' ? styles.lighten(styles.alpha(theme.palette.divider, 1), 0.72) : styles.darken(styles.alpha(theme.palette.divider, 1), 0.5));
};
...
var StyledDiv = styles.styled('div', {
...
var Row = function Row(_ref) {
  ...
  return /*#__PURE__*/React.createElement(TableRow, restProps, children);
};
...
var StyledDiv$1 = styles.styled('div')(_defineProperty({}, "&.".concat(classes$2.emptyCell), {
  height: '100%',
  width: '100%'
}));
...
var Container = styles.styled(ContainerBase)(_defineProperty({}, "&.".concat(classes.container), {
  position: 'absolute',
  width: '100%',
  top: 0,
  left: 0
...
var StyledTable = styles.styled(Table$2)(_defineProperty({}, "&.".concat(classes$3.table), {
  tableLayout: 'fixed',
  boxSizing: 'border-box'
}));
var TicksLayout = function TicksLayout(_ref) {
  ...
  }), /*#__PURE__*/React.createElement(TableBody, null, cellsData.map(function (_ref2, index) {
...
var StyledDiv$2 = styles.styled('div', {
  shouldForwardProp: function shouldForwardProp(prop) {
...
var Layout = function Layout(_ref3) {
  ...
  }, restProps), /*#__PURE__*/React.createElement(Table$2, {
    className: classes$4.timeScaleContainer
  }, /*#__PURE__*/React.createElement(TableBody, null, dxSchedulerCore.getLabelsForAllGroups(cellsData, groups, groupOrientation).map(function (groupedLabels, groupIndex) {
    var _classNames;
...
var StyledDiv$3 = styles.styled('div')(function (_ref) {
  var _ref2;
...
var StyledTableCell = styles.styled(TableCell)(function (_ref) {
  var _ref2;
...
var StyledTableMUI = styles.styled(Table$2, {
  shouldForwardProp: function shouldForwardProp(prop) {
...
var Table = /*#__PURE__*/React.forwardRef(function (_ref3, ref) {
  ...
  }, restProps), /*#__PURE__*/React.createElement(TableBody, null, children));
});
Table.propTypes = {
...
var StyledTableCell$1 = styles.styled(TableCell, {
  shouldForwardProp: function shouldForwardProp(prop) {
  ...
  return _ref2 = {}, _defineProperty(_ref2, "&.".concat(classes$8.cell), {
    ...
    '&:focus': {
      backgroundColor: styles.alpha(theme.palette.primary.main, 0.15),
      outline: 0
    }
  }), _defineProperty(_ref2, "&.".concat(classes$8.shadedCell), {
    backgroundColor: styles.alpha(theme.palette.action.disabledBackground, 0.04),
    '&:hover': {
...
var StyledTableCell$2 = styles.styled(TableCell)(function (_ref) {
...
var StyledTableCell$3 = styles.styled(TableCell)(function (_ref) {
  var _ref2;
...
var StyledTableCell$4 = styles.styled(TableCell)(function (_ref) {
  var _ref2;
...
var StyledDiv$4 = styles.styled('div')(function (_ref) {
  var _ref2;
...
var StyledDiv$5 = styles.styled('div')(function (_ref) {
  var _ref2;
...
var StyledDiv$6 = styles.styled('div')(function (_ref) {
  var _ref2;
...
var StyledDiv$7 = styles.styled('div')((_styled = {}, _defineProperty(_styled, "&.".concat(classes$f.slice), {
  position: 'absolute',
  zIndex: 50
...
var StyledToolbarMUI = styles.styled(ToolbarMUI)(function (_ref) {
  var theme = _ref.theme;
...
var StyledDiv$8 = styles.styled('div')(_defineProperty({}, "&.".concat(classes$h.flexibleSpace), {
  flex: '0 0 0',
  marginLeft: 'auto'
}));
...
var StyledDiv$9 = styles.styled('div')(function (_ref) {
...
var StyledButton = styles.styled(Button$1)(function () {
  return _defineProperty({}, "&.".concat(classes$j.textButton), _defineProperty({}, "".concat(LAYOUT_MEDIA_QUERY), {
    display: 'none'
  }));
});
var StyledIconButton = styles.styled(IconButton)(function (_ref2) {
...
var StyledIconButton$1 = styles.styled(IconButton)(function (_ref) {
  var spacing = _ref.theme.spacing;
...
var StyledTableMUI$1 = styles.styled(Table$2)(_defineProperty({}, "&.".concat(classes$l.table), {
  width: '320px',
  tableLayout: 'fixed'
}));
var Table$1 = function Table(_ref) {
  ...
  }, restProps), /*#__PURE__*/React.createElement(TableHead, null, /*#__PURE__*/React.createElement(HeaderRow, null, headerCells.map(function (cell) {
    var key = formatDate(cell.startDate, dxSchedulerCore.WEEK_DAY_OPTIONS);
    return /*#__PURE__*/React.createElement(HeaderCell, {
      key: key
    }, key);
  }))), /*#__PURE__*/React.createElement(TableBody, null, cells.map(function (row) {
    return /*#__PURE__*/React.createElement(Row, {
...
var StyledTableCell$5 = styles.styled(TableCell)(function (_ref) {
  var _ref2;
...
var StyledTableCell$6 = styles.styled(TableCell)(_defineProperty({}, "&.".concat(classes$n.cell), {
  userSelect: 'none',
  border: 'none',
  padding: 0,
  textAlign: 'center',
...
var StyledToolbar = styles.styled(ToolbarMUI)(_defineProperty({}, "&.".concat(classes$o.navigator), {
  paddingLeft: 0,
  paddingRight: 0
}));
...
var StyledTypography = styles.styled(Typography)(_defineProperty({}, "&.".concat(classes$p.text), {
  userSelect: 'none',
  flex: 1,
  textAlign: 'center'
}));
...
var StyledPopover = styles.styled(Popover)(_defineProperty({}, "& .".concat(classes$q.popover), _defineProperty({
  borderRadius: '8px',
  width: '400px'
}, "".concat(SMALL_LAYOUT_MEDIA_QUERY), {
  width: '300px'
...
var StyledDiv$a = styles.styled('div')(function (_ref) {
  var _ref2;
...
var StyledDiv$b = styles.styled('div')(function (_ref) {
  var _ref2;
...
var Content = function Content(_ref3) {
  ...
  }, restProps), /*#__PURE__*/React.createElement(Grid, {
    container: true,
    alignItems: "flex-start",
  ...
  }, weekDays)))), /*#__PURE__*/React.createElement(Grid, {
    container: true,
    alignItems: "center",
...
var StyledSelect = styles.styled(Select$1)(function (_ref) {
  var typography = _ref.theme.typography;
  return _defineProperty({}, "&.".concat(classes$t.root), {
    fontSize: typography.fontSize + 2
  });
});
var StyledOutlinedInput = styles.styled(OutlinedInput)(function () {
  var _ref3;
...
var StyledOutlinedSelect = styles.styled(OutlinedSelect)(function (_ref) {
  var _ref2;
...
var StyledTable$1 = styles.styled(Table$2)(_defineProperty({}, "&.".concat(classes$v.table), {
  tableLayout: 'fixed'
}));
var Layout$6 = /*#__PURE__*/React.memo(function (_ref) {
  ...
  }, restProps), /*#__PURE__*/React.createElement(TableBody, null, /*#__PURE__*/React.createElement(Row, null, cellsData.map(function (_ref2) {
    var startDate = _ref2.startDate,
        endDate = _ref2.endDate,
        endOfGroup = _ref2.endOfGroup,
        groupingInfo = _ref2.groupingInfo;
...
var StyledTableCell$7 = styles.styled(TableCell)(function (_ref) {
  var _ref2;
...
var StyledDiv$c = styles.styled('div')(function (_ref) {
  var _ref2;
...
var StyledTypography$1 = styles.styled(Typography)(function (_ref3) {
...
var Container$1 = styles.styled(ContainerBase)(function () {
...
var StyledDiv$d = styles.styled('div')((_styled$1 = {}, _defineProperty(_styled$1, "&.".concat(classes$y.root), {
  height: '100%',
  margin: '0 auto',
  overflowY: 'auto'
...
var StyledTextField = styles.styled(TextField)(function (_ref) {
  var _ref2;
...
var StyledDiv$e = styles.styled('div')(function (_ref) {
...
var StyledDiv$f = styles.styled('div')(function (_ref3) {
...
var StyledButton$1 = styles.styled(Button$1)(function (_ref) {
  var _ref2;
...
var StyledIconButton$2 = styles.styled(IconButton)(function (_ref) {
  var spacing = _ref.theme.spacing;
...
var StyledIconButton$3 = styles.styled(IconButton)(function () {
...
var StyledDrawer = styles.styled(Drawer)(function (_ref) {
  var _ref2;
...
var StyledTypography$2 = styles.styled(Typography)(function (_ref) {
  var _ref2;
...
var StyledFormControlLabel = styles.styled(FormControlLabel)(_defineProperty({}, "&.".concat(classes$H.label), {
  overflow: 'hidden',
  whiteSpace: 'nowrap',
  textOverflow: 'ellipsis',
  userSelect: 'none'
...
var StyledTextField$1 = styles.styled(TextField)(function (_ref) {
  var _ref2;
...
var StyledGrid$1 = styles.styled(Grid)(function (_ref) {
  var _ref2;
...
var StyledDiv$g = styles.styled('div')(function (_ref) {
  var theme = _ref.theme;
...
var StyledDiv$h = styles.styled('div')(function (_ref) {
  var theme = _ref.theme;
...
var StyledDiv$i = styles.styled('div')(function (_ref) {
  var theme = _ref.theme;
...
var StyledDiv$j = styles.styled('div')(function (_ref) {
  var _$concat2, _ref2;
...
var StyledRadioGroup = styles.styled(RadioGroup$1)(function (_ref) {
  var _ref2;
...
var EndRepeatEditor = function EndRepeatEditor(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(StyledRadioGroup, _extends({
    ...
    value: value
  }, restProps), /*#__PURE__*/React.createElement(FormControlLabel, {
    value: "never",
...
var StyledRadioGroup$1 = styles.styled(RadioGroup$1)(function (_ref) {
  var _ref2;
...
var StyledFormControlLabel$1 = styles.styled(FormControlLabel)(function (_ref) {
  var _ref2;
...
var ChangeMonthEditor = /*#__PURE__*/React__default.memo(function (_ref3) {
  ...
  var StyledLabel = styles.styled(Label)(function () {
    return _defineProperty({}, "&.".concat(classes$Q.label), {
      width: '4.5em'
    });
  });
  var StyledSelect = styles.styled(Select)(function () {
    return _defineProperty({}, "&.".concat(classes$Q.select), {
      width: 'calc((100% - 5.5em) * 3 / 7)',
      maxWidth: '8em'
    });
  });
  var StyledTextEditor = styles.styled(TextEditor)(function () {
...
var StyledDiv$k = styles.styled('div')(function (_ref) {
  var _ref2;
...
var StyledFormControlLabel$2 = styles.styled(FormControlLabel)(function (_ref3) {
  var _ref4;
...
var StyledRadio = styles.styled(Radio)(function (_ref5) {
...
var StyledButtonGroup = styles.styled(ButtonGroup)(function (_ref) {
  var spacing = _ref.theme.spacing;
  return _defineProperty({}, "&.".concat(classes$S.buttonGroup), {
    marginBottom: spacing(2)
  });
});
var StyledButton$2 = styles.styled(Button$1)(function (_ref3) {
  var _ref4;
...
var StyledDiv$l = styles.styled('div')(_defineProperty({}, "&.".concat(classes$T.container), {
  position: 'absolute',
  width: '100%',
  height: '100%'
}));
...
var StyledTextField$2 = styles.styled(TextField)(function (_ref) {
  var _ref2;
...
var StyledDiv$m = styles.styled('div')(function (_ref3) {
  var _ref4;
...
var StyledDraftAppointmentBase = styles.styled(AppointmentBase)(function (_ref2) {
  var _ref3;
...
var StyledSourceAppointmentBase = styles.styled(AppointmentBase)(function () {
...
var Container$2 = styles.styled(ContainerBase)(function () {
  return _defineProperty({}, "&.".concat(classes.container), {
    position: 'absolute',
    left: 0,
    top: 0,
...
var StyledDiv$n = styles.styled('div')(function (_ref) {
  var _ref2;
...
var StyledButton$3 = styles.styled(Button$1)(function (_ref) {
  var spacing = _ref.theme.spacing;
...
var StyledDialog = styles.styled(Dialog)((_styled$2 = {}, _defineProperty(_styled$2, "& .".concat(classes$Y.modal), {
...
var StyledDiv$o = styles.styled('div')(function (_ref) {
  var _$concat, _ref2;
...
var Layout$b = /*#__PURE__*/React.memo(function (_ref3) {
  ...
  return /*#__PURE__*/React.createElement(StyledDiv$o, restProps, /*#__PURE__*/React.createElement(DialogTitle, {
    className: classes$Z.title
  }, getMessage(isDeleting ? 'menuDeletingTitle' : 'menuEditingTitle')), /*#__PURE__*/React.createElement(DialogContent, null, /*#__PURE__*/React.createElement(RadioGroup$1, {
    value: currentValue,
    onChange: handleChange
...
var StyledDialogTitle = styles.styled(DialogTitle)(function (_ref) {
  var _ref2;
...
var Layout$c = /*#__PURE__*/React.memo(function (_ref3) {
  ...
  }, getMessage(isDeleting ? 'confirmDeleteMessage' : 'confirmCancelMessage')), /*#__PURE__*/React.createElement(DialogActions, null, /*#__PURE__*/React.createElement(Button, {
...
var StyledDiv$p = styles.styled('div', {
  shouldForwardProp: function shouldForwardProp(prop) {
...
var StyledTable$2 = styles.styled(Table$2)(_defineProperty({}, "&.".concat(classes$10.layout), {
  width: 'auto',
  '&:only-child': {
    width: '100%'
  }
...
var VerticalLayout = function VerticalLayout(_ref) {
  ...
  }, restProps), /*#__PURE__*/React.createElement(TableBody, null, dxSchedulerCore.getGroupsLastRow(groups).map(function (_, groupIndex) {
    return /*#__PURE__*/React.createElement(Row, {
      key: groupIndex.toString()
...
var StyledTableCell$8 = styles.styled(TableCell, {
  shouldForwardProp: function shouldForwardProp(prop) {
